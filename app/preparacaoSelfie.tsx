...
export default function preparacaoSelfie() {
  return (
    <SafeAreaView className="flex-1 bg-[#003F91] px-4 pt-10 p-6 items-center">
      ...
      <ScrollView contentContainerStyle={{ alignItems: "center"}}>
        ...
        <Text className="text-white text-lg font-bold mb-2">ENVIE A FOTO COM OS SEGUINTES REQUISITOS:</Text>

        <View className="w-full px-4 mb-6">
          <Text className="text-white text-sm font-bold mb-2">- A ESCOVA DE DENTE DEVE ESTAR VISIVEL NA IMAGEM DA PESSOA.</Text>
          <Text className="text-white text-sm font-bold mb-2">- A IMAGEM DEVE TER BOA ILUMINAÇÃO E ESTAR EM FOCO.</Text>
          <Text className="text-white text-sm font-bold mb-6">- A FOTO DEVE SER TIRADA EM UM AMBIENTE ADEQUADO, COMO O BANHEIRO OU FRENTE AO ESPELHO.</Text>
        </View>
