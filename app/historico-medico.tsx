    ...
    return (
        <SafeAreaView className="flex-1 items-center bg-white w-full h-full pt-12">
            ...
            <View className="flex-1 items-center">
                ...
                <Input text="SIM OU NÃO" imagem={<CalendarPlus2 size={20} color="blue" />} keyboardType="default" value={tratamento}
                    onChangeText={setTratamento}
                />

                <Text className="text-[#003EA6] text-lg mt-1 mb-2">Já realizou canal?</Text>
                <Input text="SIM OU NÃO" imagem={<CalendarPlus2 size={20} color="blue" />} keyboardType="default" value={canal}
                    onChangeText={setCanal}
                />

                <Text className="text-[#003EA6] text-lg mt-1 mb-2">Já realizou limpeza?</Text>
                <Input text="SIM OU NÃO" imagem={<CalendarPlus2 size={20} color="blue" />} keyboardType="default"   value={limpeza}
                    onChangeText={setLimpeza}
                />

                <Text className="text-[#003EA6] text-lg mt-1 mb-2">Já realizou colocação de aparelho ortodôntico?</Text>
                <Input text="SIM OU NÃO" imagem={<CalendarPlus2 size={20} color="blue" />} keyboardType="default"  value={aparelho}
                    onChangeText={setAparelho}
                />

                <Text className="text-[#003EA6] text-lg mt-1 mb-2">Já realizou alguma cirurgia?</Text>
                <Input text="SIM OU NÃO" imagem={<CalendarPlus2 size={20} color="blue" />} keyboardType="default"  value={cirurgia}
