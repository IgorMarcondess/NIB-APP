...
const path = "/login"
  return (
    <SafeAreaView className="flex-1 bg-white items-center px-4 py-6">
      ...
      <TouchableOpacity onPress={() => router.push(path)} className="bg-[#F7FAFC] border border-blue-700 rounded-xl px-4 py-6 mb-6 w-80 h-44 items-center shadow-sm" >
    ...
    <TouchableOpacity onPress={() => Linking.openURL("https://beneficiario.odontoprev.com.br/")} className="bg-[#F7FAFC] border border-blue-700 rounded-xl px-4 py-6 w-80 h-44 items-center shadow-sm" >
