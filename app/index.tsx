...
export default function Index() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-white items-center px-4 py-6">
      ...
      <TouchableOpacity onPress={() => router.push("../habitos/enviarImagem")} className="bg-[#F7FAFC] border border-blue-700 rounded-xl px-4 py-6 mb-6 w-80 h-44 items-center shadow-sm" >
