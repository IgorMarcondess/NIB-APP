...
//               <Input text="Digite seu CPF" imagem={<Feather name="credit-card" size={20} color="blue" />} keyboardType="numeric" value={value} onChangeText={onChange} />
//             )}
//           />
...
//               className="py-3 px-8 rounded-full border-2 border-white flex-row items-center justify-center"
//             >
//               {isSubmitting ? (
