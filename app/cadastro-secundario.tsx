        ...
        <View className="flex-1 items-center bg-[#003EA6] w-full h-full pt-12 px-5">
            ...
            <View className="flex-row justify-between w-full">
                <View className="w-1/2 pr-2">
                    ...
                    <TextInput className="bg-white w-full rounded-xl p-3 text-lg mb-4"
                        placeholder="Digite o CEP" placeholderTextColor="#888" keyboardType="numeric" value={cep} onChangeText={setCep}
                        returnKeyType="done"/>
                </View>
                <View className="w-1/2 pl-2">
                    <Text className="text-white text-lg self-start mb-1">Número</Text>
                    <TextInput className="bg-white w-full rounded-xl p-3 text-lg mb-4"
                        placeholder="Número" placeholderTextColor="#888" keyboardType="numeric" value={numero} onChangeText={setNumero}
                        returnKeyType="done"/>
                </View>
            </View>
