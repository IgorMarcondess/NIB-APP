  ...
  return (
    <SafeAreaView className="flex-1 bg-white p-5">
      ...
      >
        ...
        >
          <Image
            source={require("../assets/slide/slide_1.png")}
        ...
        <View className="my-4 justify-center items-center">
          ...
          <Text className="text-primary font-semibold text-sm">
            Acompanhe as novidades do mundo odontológico
          </Text>
          <CardNoticias />
        </View>
        ...
        <View className="flex-row items-center justify-center space-x-4 px-6 mb-6">
          <View className="mr-5">
            {ofensiva > 20 ? (
              <Image
                source={require("../assets/Ouro_initial.jpg")}
                className="w-20 h-24"
              />
            ) : ofensiva > 10 ? (
              <Image
                source={require("../assets/Prata_initial.jpg")}
                className="w-20 h-24 "
              />
            ) : (
              <Image
                source={require("../assets/Bronze_initial.jpg")}
                className="w-20 h-24"
              />
            )}
          </View>
        ...
        <TouchableOpacity
          ...
          onPress={() => router.push("/habitos/avaliacao")}
        >
          <Text className="text-blue-700 font-bold text-lg">
            ENVIE SEU HÁBITO DIÁRIO
          </Text>
      ...
      <BottomTabNavigator
        icons={[
          ...
          {
            name: "Diário",
            component: <Feather name="book-open" size={24} color="white" />,
            route: "/habitos/avaliacao",
          },
          {
            name: "Troféus",
            component: <Feather name="award" size={24} color="white" />,
            route: "/rank/rankUser",
          },
        ]}
      />
